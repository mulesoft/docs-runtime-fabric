= Configure Logging in Runtime Fabric
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

Runtime Fabric generates log files that

== Log Levels

- how to adjust log levels
- logging is different on RTF
- mention logs in deployment topic
...
You can view Runtime Fabric logs directly using Ops Center.
