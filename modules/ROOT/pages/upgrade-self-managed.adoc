= Upgrading Runtime Fabric on EKS, AKS, and GKE Using rtfctl

To upgrade Anypoint Runtime Fabric, upgrade Runtime Fabric components and the `rtfctl` command-line utility.
