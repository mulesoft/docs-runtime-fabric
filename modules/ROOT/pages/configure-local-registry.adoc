...
[start=6]
. In the OpenShift OCP form view, set the rtfRegistry values to configure the local registry.

+
image::ocp-local-registry.png[OCP form view to add values for rtfRegistry]
