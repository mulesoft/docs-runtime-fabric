...
+
See the xref:release-notes:runtime-fabric/runtime-fabric-release-notes.adoc#1.12.0[Runtime Fabric release notes] for a list of dependencies for your Runtime Fabric version. 
+
[NOTE]
