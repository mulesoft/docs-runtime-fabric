...
. Download the latest version of the `rtfctl` utility following the instructions provided in xref:install-create-rtf-arm#create-a-runtime-fabric-using-runtime-manager[Create a Runtime Fabric using Runtime Manager].
