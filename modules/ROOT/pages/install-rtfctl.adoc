...
[Note]
If you are using the default namespace (rtf), you do not need to specify the additional flag `--namespace <rtf_namespace>`. Note that this flag is introduced only as of rtfctl version 0.4.0.
