...
* Collect debug package information for an application
+
----
sudo ./rtfctl package delay
----
For additional troubleshooting information for your running application, refer to xref:troubleshoot-guide.adoc[Troubleshooting Guide for Runtime Fabric].
