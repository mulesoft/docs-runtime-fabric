...
.. Make sure to base64 encode the license, following the instructions in xref:install-self-managed#base64-encode-your-mule-license-key[Base64 Encode your Mule License Key].
