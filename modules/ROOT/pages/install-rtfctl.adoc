...
* Upgrades the cluster by using the installer presigned_url:

[NOTE]
You must first obtain the installer pre-signed URL via the Runtime Manager platform API or using the following https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a7-23abe036327a.anypoint-platform/runtime-fabric/minor/1.0/console/method/%232473/[Runtime Fabric API].
+
----
rtfctl appliance upgrade --url presigned_url
----
