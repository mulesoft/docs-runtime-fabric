...
With authorized namespaces, you have control of the creation of these Runtime Fabric resources:
...
If you update the authorized-namespaces ConfigMap with a new namespace, you must restart the Runtime Fabric agent deployment using this command:
