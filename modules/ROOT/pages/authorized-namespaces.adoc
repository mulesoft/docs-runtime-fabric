...
If you update authorized-namespaces Config map with a new namespace, you must restart the Runtime Fabric agent deployment running the following command:
