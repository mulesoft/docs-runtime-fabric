...
Anypoint Runtime Fabric can be installed and operated on a AWS Elastic Kubernetes Service (Amazon EKS), Azure Kubernetes Service (AKS) or Elastic Kubernetes Service (EKS), Azure Kubernetes Service (AKS), or Google Kubernetes Engine (GKE) that you manage.
