...
For private registry installations, add the `--cluster-ops-image` flag:

[source,copy]
----
rtfctl install <ACTIVATION_DATA> --cluster-ops-image <local-reg-host>/mulesoft/rtf-cluster-ops:v2.0.88
----
