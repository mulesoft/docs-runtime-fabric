...
[NOTE]
====
Runtime Fabric installation includes tasks that must be peformed by both IT administrators and MuleSoft organization administrators.
====
...
Runtime Fabric uses the `rtfctl` command-line utility for installation and management tasks.
