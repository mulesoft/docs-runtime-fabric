...
When selecting a production environment, a dialog appears to verify Runtime Fabric has been configured to operate in a production setting. This includes proper hardware configuration, log forwarding, alerting, and familiarity with possible failure modes.

[IMPORTANT]
Verify that all these steps are complete before operating and deploying production applications on Runtime Fabric.
