...
When selecting a production environment, a dialog appears to verify Runtime Fabric has been set up appropriately to operate in a production setting. This includes proper hardware configuration, log forwarding, alerting and familiarity with possible failure modes. We recommend you verify that all these steps have been completed before operating and deploying production applications on Runtime Fabric.
