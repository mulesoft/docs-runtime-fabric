...
If your Runtime Fabric is running with an unsupported configuration or does not meet the requirements for a production environment, one of these messages is displayed:
