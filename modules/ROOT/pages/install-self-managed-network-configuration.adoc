...
If you experience any issues please refer this article: https://help.mulesoft.com/s/article/Failed-to-connect-to-failover-ERROR-logs-in-RTF-application-pod-sidecar-container[ERROR in sidecar logs]
