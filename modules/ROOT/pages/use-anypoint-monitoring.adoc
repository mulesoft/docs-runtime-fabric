...
If you are upgrading from Runtime Fabric agent version 2.11.x or earlier, see xref:migrate-log-forwarding.adoc[Migrate Log Forwarding Before Upgrading Runtime Fabric] before upgrading.
