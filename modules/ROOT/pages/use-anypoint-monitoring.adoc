...
If you are upgrading from Runtime Fabric agent version 2.11.x or earlier and currently use the log forwarder DaemonSet, you must complete migration steps before upgrading. See xref:migrate-log-forwarding-3-0-0.adoc[Migrate Log Forwarding Before Upgrading to Runtime Fabric Agent Version 3.0.0].
