...
To verify that forwarding rules are in place you should run the following command:
----
...
----
IMPORTANT: These rules are node level. It means you have to run and verify them on every node, controller and worker, for Runtime Fabric to work correctly when firewalld is active.
