...
Anypoint Runtime Fabric enables you to send alerts through an existing SMTP server. Runtime Fabric has built-in alert functionality to send notifications when system health is compromised.
