...
In this case, upgrading your installer package version to 1.1.1581474166-1f657f1 or later and redeploying your applications resolves the problem. Refer to xref:https://docs.mulesoft.com/release-notes/runtime-fabric/runtime-fabric-installer-release-notes[Anypoint Runtime Fabric Installer Release Notes] and xref:upgrade-index.adoc[Upgrade Runtime Fabric] for additional information.
