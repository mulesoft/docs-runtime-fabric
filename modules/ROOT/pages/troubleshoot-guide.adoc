...
Runtime Fabric appliance version 1.1.1636064094-8b70d2d and later versions includes metrics server as a deployment in the monitoring namespace.
...
Reach out to the MuleSoft Support team with a full appliance report if you require assistance to restore the metrics server.
