...
* Try not to run a container unbounded by removing the limit completely. For OpenShift operator, removing the limit sets the agent to the default limit setting.
