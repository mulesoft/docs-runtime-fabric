...
[NOTE]
The ARM templates provided as part of the installation package are for reference only and should not be used as-is for either non-production or production Runtime Fabric installations. You will need to review and customize these according to your needs. If you require assistance with this, please contact your Customer Success Manager for guidance or to engage a MuleSoft Professional Services Consultant.
...
* `ARM-template-dev.template`: a sample Azure Resource Manager template that describes the infrastructure for the 
development configuration requirements.
* `ARM-template-prod.template`: a sample Azure Resource Manager template that describes the infrastructure for the 
...
Copy the supplied sample templates to create your own, based on your target topology and infrastructure requirements. 
