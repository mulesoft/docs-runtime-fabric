...
See xref:install-prereqs.adoc[Anypoint Runtime Fabric Installation Prerequisites].
====
...
[NOTE]
The Azure Resource Manager templates provided as part of the installation package are for reference only and should not be used as-is for either non-production or production Runtime Fabric installations. You must review and customize these templates to meet your needs. If you require assistance, contact your MuleSoft representative.
