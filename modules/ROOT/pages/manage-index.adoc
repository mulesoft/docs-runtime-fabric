...
After you install and configure Runtime Fabric and deploy Mule applications and API proxies, there are additional tasks you might need to perform.

* Monitor and View

** View Runtime Fabric status and resource usage. See xref:resource-usage.adoc[View Runtime Fabric Status and Resources].
** Use Anypoint Monitoring and Anypoint Visualizer to monitor applications deployed to Runtime Fabric. See xref:manage-monitor-applications.adoc[Monitor Applications Deployed to Runtime Fabric].
