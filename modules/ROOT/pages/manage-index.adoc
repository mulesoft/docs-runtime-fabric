...
* xref:rtf-ha-dr.adoc[High Availability and Disaster Recovery] +
Design Runtime Fabric deployments to stay available during component failures and to recover from disasters while minimizing downtime and data loss.
