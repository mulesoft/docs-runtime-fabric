...
image::architecture-development.png["Diagram of a network development architecture of the MuleSoft control plane with controllers, such as internal load balancer, agent, and workers"]
