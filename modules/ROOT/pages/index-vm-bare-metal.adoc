...
image::architecture-network.png["Diagram of the network architecture of Runtime Fabric and TCP load balancer connection with an internal load balancers of controllers and workers"]
...
image::architecture-network2.png["Diagram of the network architecture of Runtime Fabric and TCP load balancer connection with requests ping"]
