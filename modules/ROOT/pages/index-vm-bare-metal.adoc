...
image::architecture-network.png["Diagram of network architecture of a Runtime Fabric and TCP load balancer connection with internal load balancers of controllers and workers"]
