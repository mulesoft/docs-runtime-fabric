...
Depending on your Anypoint Platform subscription, you can forward log information to Anypoint Monitoring:
...
. From the *Log Forwarding* tab, select *Forward application logs to Anypoint Monitoring* checkbox.
. Click *Apply changes* to confirm the changes.

[NOTE]
====
* The *Log Forwarding* tab is hidden if the Runtime Fabric version is earlier than version 1.4.44.
* Your organization must have a Titanium subscription for Anypoint platform to have the *Forward application logs to Anypoint Monitoring* checkbox enabled.
====
