...
. Select the *Log Forwarding* tab, and then select the *Forward application logs to Anypoint Monitoring* checkbox.
...
* An Anypoint Platform Titanium subscription is required for enabling the *Forward application logs to Anypoint Monitoring* checkbox.
====
