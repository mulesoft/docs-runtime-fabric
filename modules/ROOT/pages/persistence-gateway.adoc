...
+
The standard URI for this string is `postgres://username:password@host:port/databasename`. However, the requirements for your database may be different.
+
[NOTE]
Do not use the "@" character in the username. 
