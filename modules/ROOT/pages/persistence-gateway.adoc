...
Anypoint Runtime Fabric provides Persistence Gateway, which enables Mule applications deployed to a Mule runtime engine to store and share data across application replicas and restarts.
...
Mule applications use the Object Store v2 REST API via the Mule Object Store Connector to connect to Persistence Gateway. This enables you to deploy to both Anypoint Runtime Fabric and CloudHub without having to modify your Mule application. 
