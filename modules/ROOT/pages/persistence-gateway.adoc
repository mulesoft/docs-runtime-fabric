...
+
For more information, see https://help.mulesoft.com/s/article/RTF-Persistent-Gateway-Does-Not-Allow-Login-Due-to-Account-Password-With-Special-Characters[RTF Persistent Gateway Does Not Allow Login Due to Account Password With Special Characters].
