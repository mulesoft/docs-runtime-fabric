...
To store state across applications, Anypoint Runtime Fabric provides the Persistence Gateway. Persistence Gateway enables applications deployed to a Mule runtime engine (Mule) to store and share data across replicas and re-starts of a Mule application.
