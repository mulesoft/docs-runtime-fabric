...
. Navigate to your instance of Runtime Fabric by selecting it on the Runtime Fabrics tab in Runtime Manager.
. If an upgrade is available, select "Upgrade to v1.x". The status of the Runtime Fabric instance is updated to reflect the upgrade procedure is in progress.
