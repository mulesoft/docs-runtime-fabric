= Allocating Resources for Application Deployment on Runtime Fabric
...
Review xref:limitations-self.adoc#license-compliance[MuleSoft licensing requirements] for applications deployed on Runtime Fabric instances.
