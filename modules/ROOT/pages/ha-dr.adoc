...
* Restore from an earlier backup taken on the active RTF. For information on how to back up and restore Runtime Fabric, refer to xref:runtime-fabric::manage-backup-restore[Backup and Restore Runtime Fabric].
+
