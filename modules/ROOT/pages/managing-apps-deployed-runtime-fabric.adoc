...
To manage Mule apps deployed to Anypoint Runtime Fabric, review these topics:
...
* xref:manage-apps-rtfctl.adoc[Managing Mule Apps Deployed to Runtime Fabric Using RTFCTL] +
...
* xref:restart-applications.adoc[Restarting Mule Applications] +
Restart Mule applications deployed to Runtime Fabric using Runtime Manager or the Runtime Manager API to quickly resolve runtime issues without redeploying.
