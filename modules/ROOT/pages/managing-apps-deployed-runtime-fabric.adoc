...
* xref:restart-applications.adoc[Restarting Mule Applications on Runtime Fabric] +
Use Anypoint Runtime Manager to restart Mule applications deployed to Runtime Fabric without redeploying them.
