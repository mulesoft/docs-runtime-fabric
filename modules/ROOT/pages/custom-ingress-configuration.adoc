...
KB not published
For a path-based routing ingress template, consult your ingress controller documentation and configure it accordingly. Refer to this Nginx Path-based Routing with Regex for an example using Nginx.
////
