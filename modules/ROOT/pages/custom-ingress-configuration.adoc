...
[NOTE]
====
This template is specific to https://kubernetes.github.io/ingress-nginx/deploy/[Nginx^] as the ingress controller. The final configuration of the template varies depending on the controller and ingress routing rules you use. Review the documentation for your ingress controller carefully.
====
