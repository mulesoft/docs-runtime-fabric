...
[TIP]
====
These syncronization mechanism can be used for any secret that you would like replicated from rtf agent namespace into application namespace upon deployment.
====
