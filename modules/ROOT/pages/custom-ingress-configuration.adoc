...
[NOTE]
You can use the syncronization mechanism for any secret that you would like replicated from Runtime Fabric agent namespace into the application namespace upon deployment.
