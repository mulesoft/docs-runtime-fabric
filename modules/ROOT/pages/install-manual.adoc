...
* The necessary ports are open and hostnames are allowlisted as described in xref:install-prereqs.adoc[Anypoint Runtime Fabric Installation Prerequisites].
