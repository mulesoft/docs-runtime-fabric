...
* Your controller VMs have outbound internet access. Adjust proxy configuration if needed. To add a proxy when using a cURL or `nc` command to manually download the installer bundle from the internet, ???
