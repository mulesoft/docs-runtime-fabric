...
|===
|Parameter | Description | Example
| `RTF_HTTP_PROXY` | A hostname and port for the HTTP proxy server that will forward outbound HTTP requests. | `http://1.1.1.1:80`
| `RTF_MONITORING_PROXY` | A hostname, port, and optional username and password for a SOCKS5 proxy server that will forward metrics and logs to Anypoint Monitoring. | `socks5://user:pass@1.1.1.2:800`
