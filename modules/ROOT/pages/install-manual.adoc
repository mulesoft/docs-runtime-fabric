...
| `RTF_MONITORING_PROXY` | A hostname and port, and optional username and password, for a SOCKS5 proxy server to forward metrics and logs to Anypoint Monitoring. | `user:pass@1.1.1.2:800`
