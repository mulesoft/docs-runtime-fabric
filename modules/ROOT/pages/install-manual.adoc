...
|===
|Parameter | Description | Example
| `RTF_HTTP_PROXY` | A hostname and port for a HTTP proxy server to forward outbound HTTP requests. | `http://1.1.1.1:80`
| `RTF_MONITORING_PROXY` | A hostname and port, and optional username and password, for a SOCKS5 proxy server to forward metrics and logs to Anypoint Monitoring. | `socks5://user:pass@1.1.1.2:800`
