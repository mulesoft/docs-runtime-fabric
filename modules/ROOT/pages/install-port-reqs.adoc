...
| EU control plane: `exchange2-asset-manager-kprod-eu.s3.eu-central-1.amazonaws.com`
...
| EU control plane: `prod-eu-central-1-starport-layer-bucket.s3.eu-central-1.amazonaws.com`
