...
If you cannot resolve issues with an upgrade, you can roll back the upgrade:

```
rtfctl appliance rollback
```

. After the upgrade is rolled back, update the plan status to mark the upgrade as completely rolled-back:
+
----
