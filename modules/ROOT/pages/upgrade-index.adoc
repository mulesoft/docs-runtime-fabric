...
* Verify that you have allowlisted [endpoint] on port 443, used by the runtime-registry to retrieve Docker containers for app deployments.
** After upgrading to Runtime Fabric 1.11, you must restart applications if you want them to update their deployment manifests for the runtime-registry endpoint. 
