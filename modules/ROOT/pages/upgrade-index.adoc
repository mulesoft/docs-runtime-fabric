...
After cluster-level (installer package) components are upgraded, perform the following step on *every node* to make sure system configurations are up to date:
