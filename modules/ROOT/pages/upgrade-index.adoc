...
Anypoint Runtime Fabric is a package of components which work together to provide its full set of capabilities. Updates will be delivered to these components in the following methods:
...
The latest versions of each downloadable package are found in the Downloads page, located in Anypoint Runtime Manager under the Runtime Fabrics tab. A link to each package’s release notes are provided to show the changes.
