...
+
----
sudo /opt/anypoint/runtimefabric/installer/gravity plan --repair
----
+
...
+
----
$ sudo /opt/anypoint/runtimefabric/installer/gravity plan rollback --phase=/masters/node-1/taint
$ sudo /opt/anypoint/runtimefabric/installer/gravity plan rollback --phase=/masters/node-1/system-upgrade
$ sudo /opt/anypoint/runtimefabric/installer/gravity plan rollback --phase=/masters/node-1/drain
...
----
+
...
+
----
$ sudo /opt/anypoint/runtimefabric/installer/gravity plan complete
----
