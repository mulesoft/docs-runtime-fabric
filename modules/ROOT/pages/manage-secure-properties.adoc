...
You can access secure properties from inside your Mule application using `${key}`, that is the key provided in the rtfctl apply command. You can retrieve it as any other xref:mule-runtime::configuring-properties.adoc[configuration property].
