...
You can access secure properties from inside your Mule application using `${key}`, that is the key provided in the rtfctl apply command. You can retrieve it as any other https://docs.mulesoft.com/mule-runtime/latest/configuring-properties[configuration property].
