...
* *<app_namespace>*: The Anypoint environment to scope this secure property to. Only applications deployed to this environment will have access to this secure property.
