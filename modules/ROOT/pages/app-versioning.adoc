...
image::app-versioning.png["Configuration page for a runtime fabric application, displaying application file, version, deployment target, runtime version, and replicas"]
...
+
image:app-versioning-applying-config.png["Applying configuration status for a Mule app in Runtime Manager UI"]
