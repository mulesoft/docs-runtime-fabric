...
Applications and their configurations deployed to Runtime Fabric are automatically versioned by Runtime Manager. Applicationg versioning enables you to:
