= Reviewing Application Versioning on Runtime Fabric
...
+
image::app-versioning-replica-status.png["Status of the replicas for a Mule app in the Runtime Manager UI"]
+
