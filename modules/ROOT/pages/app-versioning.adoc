...
+
image::app-versioning-replica-status.png["Status of the replicas for a Mule app in Runtime Manager UI"]
+
...
+
image::app-versioning-update-failed.png["Configuration failed to apply status for a Mule app in Runtime Manager UI"]
+
