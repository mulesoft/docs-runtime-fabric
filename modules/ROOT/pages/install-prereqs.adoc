...
* Refer to xref:index-vm-bare-metal.adoc#shared-responsibility-for-on-premises-runtime-fabric[Shared Responsibility for On-Premises Runtime Fabric].
+
...
* Red Hat (RHEL) v7.4, v7.5, v7.6, v7.7, v7.8, v8.0, v8.1, v8.2
* CentOS v7.4, v7.5, v7.6, v7.7, v7.8, v8.0, v8.1, v8.2
