...
.2+| 5044 (deprecated) .2+| TCP (Lumberjack) | US control plane: `dias-ingestor-nginx.prod.cloudhub.io` | Anypoint Monitoring agent for Runtime Fabric. The use of this port is deprecated in Runtime Fabric version 1.8.48. If you are using a previous version you must add port 5044 to your allowlist.
