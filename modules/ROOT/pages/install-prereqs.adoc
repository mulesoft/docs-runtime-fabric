...
[NOTE]
If you're using VMWare and are unable to connect to your existing applications or deploy new applications refer to https://help.mulesoft.com/s/article/RTF-Networking-Issues-with-VMware[RTF Networking Issues with VMware^] in the MuleSoft Knowledge Base. 
...
image::architecture-production.png["Diagram of a Mule development with control plane, controllers, such as internal load balancer, agent, workers, and TCP load balancer"]
...
image::architecture-development.png["Diagram of a network development architecture of MuleSoft control plane with controllers, such as internal load balancer, agent, and workers"]
