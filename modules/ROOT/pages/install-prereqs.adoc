...
*** If you plan to configure a TLS context using PEM or JKS certificates, you must have the necessary permissions for the Runtime Fabric environment you want to use for applications: Refer to xref:docs-anypoint-security/configure-tls-context-rtf-lb.adoc[Configure a TLS Context for Anypoint Runtime Fabric] for details about the permissions needed.

*** Perform the prerequisite TLS context configuration tasks described in xref:docs-anypoint-security/configure-tls-context-rtf-lb.adoc[Configure a TLS Context for Anypoint Runtime Fabric].
