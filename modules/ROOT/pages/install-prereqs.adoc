...
image::architecture-production.png["Diagram of a Mule development with control plane, controllers, such as an internal load balancer, agent, workers, and TCP load balancer"]
