...
.2+| 5044 .2+| TCP (Lumberjack) | US control plane: `dias-ingestor-nginx.prod.cloudhub.io` | Anypoint Monitoring agent for Runtime Fabric.(Legacy)
| EU control plane: `dias-ingestor-nginx.prod-eu.msap.io`| Anypoint Monitoring agent for Runtime Fabric.(Legacy)
