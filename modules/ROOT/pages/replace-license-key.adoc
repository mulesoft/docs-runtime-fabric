...
*** use a WSL or Cygwin shell which should include the base64 tool and use the above Unix command 
*** use the base64.exe program included by windows git (e.g. C:\Program Files\Git\usr\bin) or 
*** use the following Powershell command instead:
+
----
