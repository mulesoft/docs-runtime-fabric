...
Anypoint Monitoring requires a proxy for communication. The type of proxy you need to configure depends on your Runtime Fabric version.

.Anypoint Monitoring Proxy Configuration
|===
|Runtime Fabric Version |Required Proxy Type |Configuration Details

|*2.6.22 and Later*
|*HTTP Proxy*
|For detailed steps, refer to <<configure-http>>.

|*Earlier than 2.6.22* and *Legacy Deployments*
|*SOCKS5 Proxy*
|For detailed steps, refer to <<configure-socks5>>.
|===

[[configure-socks5]]
== Configure a SOCKS5 Proxy for Runtime Fabric

Make sure your SOCKS5 proxy connects to Anypoint Monitoring over TCP at these endpoints, depending on your control plane:
