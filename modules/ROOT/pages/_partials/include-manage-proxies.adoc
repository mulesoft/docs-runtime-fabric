...
For Runtime Fabric deployments on version 2.6.22 and later, Anypoint Monitoring uses an HTTP proxy. Refer to <<configure-http, Configure an HTTP Proxy for Services in Runtime Fabric>> for details. 
