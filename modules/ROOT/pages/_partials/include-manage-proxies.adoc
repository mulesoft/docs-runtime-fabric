...
[NOTE]
Starting Runtime Fabric version 2.6.20, the following HTTP proxy is needed for Anypoint Monitoring sidecar or agents as well. SOCK5 proxy is not required for Mule apps deployed on Runtime Fabrics with version less than 2.6.22.
...
`us1.ingest.mulesoft.com/api/v2/lmetrics` +
`us1.ingest.mulesoft.com/api/v2/metrics` +
`us1.ingest.mulesoft.com/api/v2/traces` +
`us1.ingest.mulesoft.com/api/v2/logs` +

* EU control plane: +
`dias-ingestor-nginx.prod-eu.msap.io` +
`dias-ingestor-router.eu-central-1.prod-eu.msap.io` +
`eu1.ingest.mulesoft.com/api/v2/lmetrics` +
`eu1.ingest.mulesoft.com/api/v2/metrics` +
`eu1.ingest.mulesoft.com/api/v2/traces` +
`eu1.ingest.mulesoft.com/api/v2/logs` +
