...
Note that Anypoint Monitoring xref:configure-a-monitoring-proxy.adoc[uses its own proxy settings], as do xref:configure-a-proxy-for-a-mule-application.adoc[Mule applications].
