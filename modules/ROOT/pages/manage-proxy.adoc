...
+
Runtime Fabric looks for upper-case values for the hosts, but if upper-case values are missing, Runtime Fabric will pick lower-case values. If both values are present, Runtime Fabric picks the upper-case values.
