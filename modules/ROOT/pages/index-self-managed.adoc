...
To retrieve logs for a Mule application deployed in a Docker container on Runtime Fabric on Self-Managed Kubernetes, send them to `stdout`. Refer to the Docker logging documentation for details.  
