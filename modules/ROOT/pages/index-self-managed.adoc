...
See the xref:runtime-fabric::runtime-fabric-release-notes.adoc[release notes] for your major or minor version of Runtime Fabric for a list of supported Kubernetes versions.
