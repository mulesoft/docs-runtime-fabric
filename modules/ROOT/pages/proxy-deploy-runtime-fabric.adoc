...
To deploy API proxies to a Mule runtime, you must have these permissions on your account:
...
. In the *Deployment Configuration* section, configure this:
+
...
. Enable last-mile security on the application using the instructions in https://help.salesforce.com/s/articleView?id=001117051&type=1[How to enable last-mile security in Runtime Fabric (RTF)].
