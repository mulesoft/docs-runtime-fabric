...
. Export and deploy the gateway using Runtime Manager according to the instructions in xref:deploy-to-runtime-fabric.adoc[Deploy a Mule Application to Runtime Fabric].
