...
. Export and deploy an app into Runtime Manager using the instructions in xref:deploy-to-runtime-fabric.adoc[Deploy a Mule Application to Runtime Fabric].
