...
[IMPORTANT]
--
Mutual authentication for connectivity between Runtime Fabric and the Anypoint Platform control plane is enabled by default for Runtime Fabric versions 1.6.45 and later. The following instructions to enable mutual authentication are relevant only to those versions earlier than 1.6.45.
--
