...
[IMPORTANT]
--
Mutual authentication for connectivity between the Runtime Fabric and Anypoint control plane is enabled by default for all versions of Runtime Fabric released after 7/15/2020. The following instructions to enable mutual authentication are relevant only to those versions released before 7/15/2020.
--
...
If you're on a version of Runtime Fabric released before 7/15/2020, you can enable mutual authentication using the Runtime Fabric API. Or, on Anypoint Runtime Fabric version 1.3.60 or later, you can use Runtime Manager to enable it.
