...
. If, after fully installing Runtime Fabric, you later add or delete any namespaces, you must restart the Runtime Fabric agent pod. To do so, run the following command:
+
[source,copy]
----
