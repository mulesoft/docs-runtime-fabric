...
To obtain the Helm registry endpoints and credentials, make a request to the following API endpoint. Replace `ORG_ID`` with your organization's ID:

https://anypoint.mulesoft.com/runtimefabric/api/organizations/<ORG_ID>/helmrepoproperties 
