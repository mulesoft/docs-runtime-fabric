...
. Create a namespace in which to install Runtime Fabric 
...
== Create A Namespace to Install Runtime Fabric 

You must create a namespace in your Kubernetes cluster in which to install Runtime Fabric. This namespace is where you install Runtime Fabric components. 
...
=== Configure an Authorized Namespace
...
|===
|Key |Value |Example
|`customLog4jEnabled` |Enables or disables custom Log4j configurations | `customLog4jEnabled: false`, default is `true`
