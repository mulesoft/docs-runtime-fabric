...
[NOTE]
If you configure these values and then roll back a Runtime Fabric instance to a previous version, the configuration isn't be applied to the older version.
