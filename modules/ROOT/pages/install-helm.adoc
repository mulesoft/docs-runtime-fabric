...
* Runtime Fabric has cluste-rwide permissions for the `rtf:resource-metrics-collector` clusterRole. These permissions apply to all nodes, pods, and namespaces.
