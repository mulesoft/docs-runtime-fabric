...
Watch this video to see how to protect property values in Runtime Manager through Runtime Manager:

++++
include::_partials/rtf-protect-app-properties-video.html[]
++++
