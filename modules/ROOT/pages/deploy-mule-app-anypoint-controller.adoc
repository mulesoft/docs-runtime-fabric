...
* Deploy Mule applications using declarative Mule application Custom Resources.
...
[IMPORTANT]
Backup and restore functionality (during the Limited GA phase) is not supported. Plan your recovery strategy accordingly, leveraging your Git repository as the source of truth for application configurations.
...
* Have an existing Runtime Fabric installation using Helm.
* xref:install-helm.adoc[Install Runtime Fabric]) or xref:upgrade-helm.adoc[upgrade Runtime Fabric]  using Helm.
