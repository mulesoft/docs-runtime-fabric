...
* Record the name of the Runtime Fabric.
* Record the activation data for the Runtime Fabric.

During installation, the installation package is downloaded to a VM that serves as the leader of the installation. In this document, this VM is referred to as the installer VM. After installation, it will serve the same function as a controller VM.
