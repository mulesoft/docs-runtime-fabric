...
----
+
When a dedicated node is added to the cluster, the option to specify a dedicated node is provided when you enable inbound traffic. For dedicated nodes, you can specify the amount of CPU cores and Memory.
