...
* The necessary ports are open and hostnames are added to allowlists as described in xref:install-prereqs.adoc::network-and-port-requirements[Network and Port Requirements].
