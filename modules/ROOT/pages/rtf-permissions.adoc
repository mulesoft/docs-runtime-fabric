...
.10+|<rtf-namespace>|extensions, apps   |deployments, deployments/scale, daemonsets, replicasets   | *
   ...
   |rtf.mulesoft.com  |persistencegateways, kubernetestemplates, httproutetemplates, muleapplications, muleapplications/status   | *
   |autoscaling  |horizontalpodautoscalers   | *
   |high availability  |leases   | *
|===
