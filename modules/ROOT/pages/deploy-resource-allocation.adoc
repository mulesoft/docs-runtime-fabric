...
Edge memory requirements are impacted by the number of threads, response time latency, and message sizes. The following Edge memory allocations are recommended:
