...
== Differences Between CloudHub and Runtime Fabric

Anypoint Platform allocates both core and heap memory for an application. Heap memory is dynamically allocated and used for things like handling payload. Both CloudHub and Runtime fabric allocate both types of memory. However, they differ in how memory allocation of each type is calculated.
