...
The resources allocated to your Mule application determine the application's performance. Following are the approximate values for throughput based on the total umber of vCPU cores allocated for a single Mule application performing simple processing on a 10-KB payload:
