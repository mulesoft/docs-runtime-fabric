...
You are responsible for ensuring you remain compliant with your MuleSoft licensing. To remain compliant, ensure that you do not exceed the amount of CPU cores provided by your MuleSoft license at any given time.
...
+
You might see multiple data points for a certain time frame depending on data granularity. To get an accurate assessment of core CPU usage, look for the highest number within the selected time frame. 
