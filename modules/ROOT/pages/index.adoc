...
| VMs / Bare Metal | Creates and configures the infrstructure that runs Runtime Fabric. This person is also responsible for installing Runtime Fabric and maintaining the underlying infrastructure during its operation. | Creates Runtime Fabrics, deploys projects, and performs other tasks within Anypoint Platform.
|===
