...
Application pods in the worker namespace must communicate with the resource cache in the Runtime Fabric agent namespace to retrieve deployable artifacts.
