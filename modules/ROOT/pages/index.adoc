...
| Support for installing on any Linux distribution | Supported | Support for RHEL and CentOS only
| Support for node auto-scaling | Supported using AWS or Azure functionality | Not supported
