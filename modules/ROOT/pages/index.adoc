...
* MuleSoft responsibility - MuleSoft manages the health of the Runtime Fabric appliance and components, Mule runtime engine, and applications that are deployed to Runtime Fabric.
* Customer responsibility - Customers are responsible for provisioning, configuring, and managing the infrastructure required for Runtime Fabric.
+
