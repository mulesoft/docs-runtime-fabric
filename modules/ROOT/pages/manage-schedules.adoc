...
[NOTE]
The minimum required Mule runtime engine version to use this feature is 4.1.2 and above, and the minimum Runtime Fabric Agent version is 2.0.0 and above.
