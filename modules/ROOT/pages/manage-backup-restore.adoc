...
For Runtime Fabric on VMs / Bare Metal, the backup and restore process includes backing up and restoring appliance-related custom resources such as logforwarder and smtp. It does not include backing up of metrics (influxdb) data generated from the applications.
