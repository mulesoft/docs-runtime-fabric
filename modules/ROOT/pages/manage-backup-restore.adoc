...
Before using the backup and restore functionality, verify your Runtime Fabric was installed or upgraded using the link:https://docs.mulesoft.com/release-notes/runtime-fabric/runtime-fabric-installer-release-notes[installer version 1.1.1561762676] or greater. The version of the installer can be verified by running `gravity status` on a Runtime Fabric node.
...
. Log in to one of the controller nodes in your Runtime Fabric as a privileged user (with root access).
