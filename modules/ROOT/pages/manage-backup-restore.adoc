...
using  https://docs.mulesoft.com/release-notes/runtime-fabric/runtime-fabric-installer-release-notes[installer version 1.1.1581474166, role=external, window=_blank] or greater, and rtfctl CLI tool is upgraded to version 0.2.95 or greater.
