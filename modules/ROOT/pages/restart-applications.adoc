...
Before restarting a Mule application, ensure that you have the required permissions:

* You must have the *Restart Applications* permission to restart applications.

To grant the *Restart Applications* permission to a user:
...
. Select *Restart Applications* from the list of permissions and click *Next*.
+
