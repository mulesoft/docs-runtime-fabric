...
[IMPORTANT]
If you're using Runtime Fabric on Red Hat OpenShift, see xref:install-openshift.adoc#prepare-for-deploying-mule-apps-to-red-hat-openshift[Prepare for Deploying Mule Apps to Red Hat OpenShift] for necessary configuration steps. 
