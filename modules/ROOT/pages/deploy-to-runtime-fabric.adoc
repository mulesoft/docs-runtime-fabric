...
* Install and configure Anypoint Runtime Fabric. Refer to the installation instructions for xref:install-self-managed.adoc[Runtime Fabric] for more information.
...
Anypoint Monitoring provides access to log data for applications deployed to Rutime Fabric. To access logs with Anypoint Monitoring, you need a https://www.mulesoft.com/anypoint-pricing[Titanium subscription].

. Click the *Logging* tab.
. Select the *Enable application logs* option.
. To configure additional log levels, use the drop-down list to select the log level:
+
