...
.. In the *Public endpoint* section, select a domain from the *Application url* list.
+
By default, If you do not select a domain, the first domain listed in the Application url list is used for the application.
