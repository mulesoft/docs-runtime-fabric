...
To learn more about Mule runtime versions supported on Runtime Fabric, refer xref:release-notes::runtime-fabric/runtime-fabric-runtimes-release-notes.adoc[Anypoint Runtime Fabric Patch Update Release Notes]
