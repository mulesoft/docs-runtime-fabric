...
+
This option is only available on Mule runtime engine, version 4.2.1 or later. See xref:persistence-gateway.adoc[Persistence Gateway] for more information.
