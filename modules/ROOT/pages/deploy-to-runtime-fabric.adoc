...
+
The *Deployment Target*, *Ingress*, and *Properties*, *JVM* and *Logs* tabs are displayed. Use these tabs to enter additional configuration information for your application.
+
