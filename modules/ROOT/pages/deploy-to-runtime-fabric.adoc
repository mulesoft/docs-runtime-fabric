...
The Mule runtime disables TLSv1 and TLSv1.1 by default. When you deploy an application to Runtime Fabric, you can enable TLSv1 or TLSv1.1 using JVM args.

. Click the *JVM* tab. 
. In the *Java Virtual Machine arguments*, enter one of the following arguments:
