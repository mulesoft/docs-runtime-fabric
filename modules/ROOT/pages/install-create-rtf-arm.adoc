= Beginning Runtime Fabric Installation on VMs / Bare Metal
...
* Create your clusters using the latest Runtime Fabric agent version available. If you can't do so, refer to https://help.salesforce.com/s/articleView?id=001117134&type=1[How to Specify the RTF Agent Version in Upgrades^].
