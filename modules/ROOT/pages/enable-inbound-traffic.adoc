...
+
To address more advanced use cases, refer to the instructions in xref::configure-adv-tls-context.adoc[Configure a TLS Context for Runtime Fabric Load Balancer] to use a Secrets Manager TLS context.
+
...
+
To generate a certificate for testing, refer to Generate a TLS Certificate for Testing.
