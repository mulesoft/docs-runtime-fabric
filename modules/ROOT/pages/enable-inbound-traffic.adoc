...
+
Because certificates are not used in this case, click *Add Domain* and manually enter domains for routing requests to applications. Skip the xref:.adoc[Configure a TLS context for HTTPS] task.
+
[NOTE]
