...
If a Mule application takes longer to respond than this value, the connection is automatically closed. +
...
This value enables large payloads be terminated to keep resources available.+
