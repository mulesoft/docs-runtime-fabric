...
For Runtime Fabric versions 1.5.0 or later, the inbound traffic software version is only upgraded after the Runtime Fabric version is upgraded. The next inbound traffic software deployment (following the Runtime Fabric version upgrade) triggers the new inbound traffic software version to run. Runtime Fabric versions earlier than 1.5.0 will trigger inbound traffic software version updates at deployment times independent of Runtime Fabric version upgrades.
