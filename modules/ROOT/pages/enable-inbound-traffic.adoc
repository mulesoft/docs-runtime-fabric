...
+
A security policy must be defined in Anypoint Security to be displayed as an option in the *HTTP Limits*, *Web Application Firewall (WAF)*, *IP Allowlist*, or *Denial of Service (DoS)* dropdown lists. 
+
[NOTE]
