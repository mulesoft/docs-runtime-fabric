...
+
Refer to the instructions in xref::configure-adv-tls-context.adoc[Configure a TLS Context for Runtime Fabric Load Balancer] to use a Secrets Manager TLS context.
