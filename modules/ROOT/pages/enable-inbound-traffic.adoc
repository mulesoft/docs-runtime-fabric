...
. In the *Basic Configuration* section, select one of the following Protocol options:
...
+
If you select this option, all certs are deleted.
...
+
The Protocol option that you selected determines how HTTP and HTTPS requests are handled:
+
...
** Option 3: *Import from Secrets Manager* (for advanced users) - THIS SECTION TO BE MOVED TO ANYPOINT SECURITY DOCS!!!
+
