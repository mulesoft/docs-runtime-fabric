...
* If multiple namespaces use the same `Environment_ID` label, Runtime Fabric deploys applications to the first namespace listed by Kubernetes that uses the label.
