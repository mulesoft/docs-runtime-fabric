...
Review these Kubernetes best practices for Runtime Fabric. To use the complete value of Runtime Fabric, you can refer to your respective Kubernetes (K8s) provider's configuration specification for details.
