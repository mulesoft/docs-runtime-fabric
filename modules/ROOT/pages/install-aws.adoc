...
This topic describes how to install Anypoint Runtime Fabric on your AWS account. Note that you can also use AWS EKS to install xref:index-self-managed.adoc[Runtime Fabric on Self-Managed Kubernetes].
