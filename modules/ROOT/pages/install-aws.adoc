...
* Download and manually install https://terraform.io/[Terraform] on your machine. Verify that the version of Terraform installed is `0.11.7` or later by running `terraform --version` on your terminal.
