...
| Replicas per application | Runtime Fabric supports maximum 16 replicas per application in all forms except when the you use usage pricing and Horizontal Pod Autoscaling feature. In this case, the maximum number of replicas per application is 8.
