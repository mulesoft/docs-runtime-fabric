...
Refer to the xref:release-notes::runtime-fabric/runtime-fabric-release-notes-3.x.x.adoc[release notes] for the list of supported Kubernetes versions for your Runtime Fabric.
