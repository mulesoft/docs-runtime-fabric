...
Review these requirements and limitations before installing, configuring, and managing Anypoint Runtime Fabric. 
...
To successfully use Anypoint Runtime Fabric, your Anypoint Platform account must have these permissions:
...
+
[NOTE]
For Runtime Fabric, the *Create application* permission in Runtime Manager is required for PUT/PATCH application API calls. The *Manage Application Data* and *Manage Settings* permissions apply only to CloudHub and are not available for Runtime Fabric or CloudHub 2.0.
