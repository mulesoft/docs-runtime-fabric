...
include::anypoint-cli::partial$cloudhub2-apps.adoc[tags=summary,leveloffset=+1,tags=!excludeAppDeploy]

include::anypoint-cli::partial$cloudhub2-apps.adoc[tags=commands,leveloffset=+1,tags=!excludeAppDeploy]
