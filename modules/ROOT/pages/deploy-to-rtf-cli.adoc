...
Additionally, you can add more parameters to deploy your Mule app. If you want your app to have two replicas instead of one, you can write `--replicas 2`  at the end of your script.
