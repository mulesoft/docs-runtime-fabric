...
. On the first full week of the month, you have access to new date-patches of updated Mule runtimes.
...
[NOTE]
During the grace period, you can select earlier date-patch versions until they are no longer available. If you select an earlier date-patch, and make any subsequent changes to that application, you may be required to update its date-patch version to a later release.
