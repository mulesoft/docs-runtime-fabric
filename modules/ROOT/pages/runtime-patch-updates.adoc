...
| Versions 4.4 and previous |The deployment defaults to or autoupgrades to the latest patch of the selected minor. | Anypoint Platform API requires passing a valid and supported build tag in the deployment specification. If you pass a wrong build tag, the deployment fails.


If you deploy a Mul app without the build tag, the deployment defaults to or autoupgrades to the latest patch of the selected minor.
