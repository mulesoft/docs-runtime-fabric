...
* Run the upgrade procedure on a nonproduction instance of Runtime Fabric to verify compatibility with your environment and to gain familiarity with the procedure.
...
. Update your Mule deployments running on this Anypoint Runtime Fabric instance to the latest patch version.
...
.. Repeat this for each application running on this instance of Runtime Fabric.
