...
.. The value in the Runtime version field will indicate if an update is available. Select the updated version of Mule runtime.
.. Select *Deploy* to redeploy the application with the updated Mule runtime version.
