= Deploying and Managing Applications to Runtime Fabric
...
To deploy Mule applications and API proxies using Maven, see xref:deploy-maven-4.x.adoc[Deploy an Application to Runtime Fabric using Maven (Mule 4)].
