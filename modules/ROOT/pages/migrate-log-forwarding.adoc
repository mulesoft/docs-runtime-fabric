...
. <<enable-app-scoped-log-forwarding,Enable Application-Scoped Log Forwarding>>
. <<redeploy-apps-legacy-log-forwarding,Redeploy Applications Using Legacy Log Forwarding>>
. <<remove-log-forwarder-daemonset,Remove the Log Forwarder DaemonSet>>
. <<verify-log-forwarding-migration,Verify Migration>>
...
* xref:use-anypoint-monitoring.adoc#logs[Enable and Configure Log Forwarding]
