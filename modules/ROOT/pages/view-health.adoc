...
If you are using Runtime Fabric on VMs / Bare Metal, you can view additional performance and Runtime Fabric cluster health information using the Ops Center. See xref:using-opscenter.adoc[Use the Ops Center to Monitor Runtime Fabric] for more information.
