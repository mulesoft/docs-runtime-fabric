...
* Don't use synchronous log appenders.
* Don't change anything in the console appender or Anypoint Monitoring appender.
+
...
You can also enable custom Log4j configurations by running these steps:
