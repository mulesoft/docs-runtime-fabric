...
If you enabled Custom Log4j in the `values.yaml` during the installation of Runtime Fabric and you want to disable it the RTF cluster level, follow these steps:
