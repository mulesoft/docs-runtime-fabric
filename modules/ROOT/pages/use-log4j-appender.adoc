...
To use custom Log4kj and Anypoint Monitoring logging at the same time, you must add a specific Anypoint Monitoring console appender pattern to your app log4j2.xml file:
