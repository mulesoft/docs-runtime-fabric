...
This topic describes how to use Runtime Manager or the built-in Ops Center to monitor the health of your Anypoint Runtime Fabric clusters.
...
graphs showing the CPU, JVM Heap Memory, Total Memory, Network, and Filesystem usage.
