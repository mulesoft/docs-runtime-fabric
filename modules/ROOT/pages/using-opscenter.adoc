...
. In Ops Center, click * *Kubernetes* on the left sidebar.
...
The page should redirect to the *Monitoring* tab with a filter applied to your application. By default, Ops Center displays a set of graphs showing the CPU, Memory, Network, and Filesystem usage.
