...
If you need any of the following capabilities, use the appropriate feature in Anypoint Platform:

* SSO integration
* Detialed application monitoring with Anypoint Monitoring
* Detailed health reporting for Runtime Fabric
