= Monitor Anypoint Runtime Fabric
...
graphs showing the CPU, Total Memory, Network, and Filesystem usage.
As of Runtime Fabric version 1.7, JVM Heap Memory is now available under Anypoint Monitoring.
