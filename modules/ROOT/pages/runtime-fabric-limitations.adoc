...
| Object Store Persistence | To handle data persistence across Mule application replicas and restarts Anypoint Runtime Fabric uses the Persistence Gateway. See xref:persistence-gateway.adoc[Persistence Gateway]. Anypoint Runtime Fabric does not support using Object Store for data persistence. 
|===
