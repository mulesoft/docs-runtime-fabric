...
| RHEL 7 | If the host operating system is RHEL 7, and you have enabled SELinux, third-party software running on the host may tweak policy settings from SELinux.
|===
