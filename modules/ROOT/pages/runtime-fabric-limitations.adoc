...
https://docs.mulesoft.com/mule-runtime/4.3/creating-and-managing-a-cluster-manually#object-store-persistence[Object Store Persistence] is not currently supported for Runtime Fabric clusters.
