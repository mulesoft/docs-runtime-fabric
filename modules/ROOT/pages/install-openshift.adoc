...
[NOTE]
Runtime Fabric has clusterwide permissions for the rtf:resource-metrics-collector clusterRole. These permissions apply to all nodes, pods, and namespaces.
...
[source,copy]
----
oc delete pod <agent-pod-name> -n <agent-namespace-name>
----
+
