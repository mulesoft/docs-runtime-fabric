...
++++
include::_partials/rtf-openshift-video.html[]
++++
...
[source,copy]
----
oc create secret docker-registry <pull_secret> --namespace <namespace> --docker-server=<docker_registry_url> --docker-username=<docker_registry_username> --docker-password=<docker_ registry_password>
----
