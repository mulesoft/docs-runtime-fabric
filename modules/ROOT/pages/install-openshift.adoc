...
. On your Red Hat OpenShift cluster, apply the following ClusterRoleBinding. Be sure to replace the `<your_namespace>` placeholder with the value you created in step 1.
+
[source,yaml]
--
