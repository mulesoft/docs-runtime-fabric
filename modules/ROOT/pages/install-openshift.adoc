...
When you use install Runtime Fabric on Red Hat OpenShift, you’ll:
...
[IMPORTANT]
--
* If you want to set up shared tenancy, you must configure it before installing Runtime Fabric. See xref:shared-tenancy.adoc[Configuring Shared Tenancy in Runtime Fabric] for instructions. 
--
...
In your Red Hat OpenShift cluster, create a namespace for installing Runtime Fabric. This namespace is where you install Runtime Fabric components. 
...
Before you deploy any Mule applications to your Red Hat OpenShift cluster, perform the following steps. 
