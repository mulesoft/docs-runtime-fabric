...
. In your cluster, create an additional namespace in which to run Runtime Fabric:
+
[source,copy]
----
...
----
+
Repeat this step to add as many namespaces as you need. 

. Add the `rtf.mulesoft.com/role=workers` label to the namespace:
+
[source,copy]
----
oc edit <namespace> --> add label rtf.mulesoft.com/role=workers
----
...
. In your cluster, create a ConfigMap file named shared-tenancy and list any additional namespaces:
+
[source,copy]
----
apiVersion: v1
