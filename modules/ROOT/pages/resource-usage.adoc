...
You can use Anypoint Runtime Manager to view the resource usage and health of your Anypoint Runtime Fabric clusters.
...
+
For example, if your Runtime Fabric cluster configuration meets production environment requirements, the following information is displayed:
+
```
