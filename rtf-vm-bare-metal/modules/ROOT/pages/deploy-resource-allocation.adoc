= Resource Allocation and Performance on Runtime Fabric on VMs/Bare Metal
...
include::partial$include-deploy-resource-allocation.adoc[tags=licenseCompliance]
...
include::partial$include-deploy-resource-allocation.adoc[tags=loadBalancerMemoryAllocation]
include::partial$include-deploy-resource-allocation.adoc[tags=internalLoadBalancer]
