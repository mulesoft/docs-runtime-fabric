...
* Make sure your environment meets all prerequisites described in the following sections. If needed, contact your MuleSoft representative for assistance.

== Knowledge Required to Install Anypoint Runtime Fabric (Runtime Fabric)
...
== General Prerequisites for Anypoint Runtime Fabric Installation
